...
def main():
    ...
    restore_from = '' # './models/exp-schp-201908261155-lip.pth'
    ...
    if os.path.exists('./models/exp-schp-201908261155-lip.pth'): # './models/exp-schp-201908261155-lip.pth'
        print('Resuming schp checkpoint from {}'.format('./models/exp-schp-201908261155-lip.pth'))
        schp_checkpoint = torch.load('./models/exp-schp-201908261155-lip.pth')
        schp_model_state_dict = schp_checkpoint['state_dict']
        cycle_n = 1
        schp_model.load_state_dict(schp_model_state_dict)

    # Loss Function
    criterion = CriterionAll(lambda_1=1, lambda_2=1.5, lambda_3=0.1,
    ...
    for epoch in range(start_epoch, 5):
        ...
        schp.save_schp_checkpoint({
            ...
            }, False, './log', filename='0503_test_{}.pth.tar'.format(epoch + 1))
        ...
        if (epoch + 1) >= 1 :
            ...
            schp.save_schp_checkpoint({
                ...
                'cycle_n': cycle_n,
            }, False, './log', filename='0503_schp_{}_checkpoint.pth.tar'.format(cycle_n))

        torch.cuda.empty_cache()
        end = timeit.default_timer()
        print('epoch = {} of {} completed using {} s'.format(epoch, 5,
