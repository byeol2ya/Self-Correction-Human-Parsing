...
def main():
    ...
    wandb.init(project="0314_lip_added_train_mac")
    ...
    restore_from = './log/train_checkpoint_1/checkpoint_10.pth.tar'
    ...
    if os.path.exists('./models/exp-schp-201908261155-lip.pth'):
    ...
    train_dataset = OURDataSet('B:/Datasets', 'train', input_size=input_size, transform=transform)
    train_loader = data.DataLoader(train_dataset, batch_size=56,
